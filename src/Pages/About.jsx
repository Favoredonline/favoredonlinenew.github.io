  ...
  return (
    <div className="mx-auto px-4 sm:px-6 lg:px-8 mb-10">
      <div className="text-center">
        ...
        <p>Founded in July 2018, and originally registered as Favored Online Skills Acquisition Network in March 2020, the company was rebranded and officially incorporated as Favored Online Inc. in Delaware, USA.</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-10 lg:mx-20">
        ...
        <div className=" text-white flex flex-col justify-center leading-7 md:leading-10">
          ...
          <p className="mb-4">My name is <a href="https://www.linkedin.com/in/opeyemi-adeniran/" target="_blank" rel="noopener noreferrer" className="text-[#D2AE2F] font-semibold">Opeyemi T. Adeniran</a>,  </p>
        </div>
      </div>
    </div>
  );
