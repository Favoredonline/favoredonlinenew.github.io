...
const About = () => {
  ...
  <strong>Favored Online Inc.</strong>, founded in July 2018 and originally registered as Favored Online Skills Acquisition Network in March 2020, was rebranded and officially incorporated as Favored Online Inc.<br><br>
  It serves as the parent holding company for two initiatives: <strong className="text-[#D2AE2F]">TechTalents City</strong> and <strong className="text-[#EB48D5]">She Model Tech.</strong>
      ...
      <div className="flex flex-col md:flex-row gap-10 lg:mx-20">
        ...
        <div className=" text-white flex flex-col justify-center leading-7 md:leading-10">
         ...
         <p className="mb-4">
  Hello, I'm <a href="https://www.linkedin.com/in/opeyemi-adeniran/" target="_blank" rel="noopener noreferrer" className="text-[#D2AE2F] font-semibold">Opeyemi T. Adeniran</a>, an AI Research Engineer and the founder of three innovative initiatives: <strong className="text-[#D2AE2F]">TechTalents City</strong>, <strong className="text-[#EB48D5]">She Model Tech</strong>, and <a href="https://www.morgantechfest.com/" target="_blank" rel="noopener noreferrer" className="text-[#D2AE2F] font-semibold">Morgan TechFest</a>.
</p>
        </div>
      </div>
    </div>
